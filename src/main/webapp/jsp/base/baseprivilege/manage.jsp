...
%>
<div class="page-header">	<form id="searchForm" action="basePrivilege/query.do" method="post" class="form-inline" role="form">		<div class="form-group">
...
<script type="text/javascript">
	(function(){
		...
		$('#newBtn').click(function(){
			loadMain('basePrivilege/detail.do');
		})
		//编辑按钮权限
		$('#editBtn').click(function(){
			if($.core.grids[0].checkSelect() == true){
				loadMain('basePrivilege/detail.do?id=' + $.core.grids[0].curId);
			}
		})
		//删除按钮权限
		$('#delBtn').click(function(){
			if($.core.grids[0].checkSelect() == true){
				confirm("确认删除?",function(){
					ajaxGet("basePrivilege/delete.do?id="+$.core.grids[0].curId,function(data){
						if(data.sign == true){
							alert("删除成功");
							refreshPage();
						}else{
