...
<script type="text/javascript">
	(function(){
		...
		$('#newBtn').click(function(){
			loadMain('baseRoleMenuPrivilege/detail.do');
		})
		//编辑角色菜单权限
		$('#editBtn').click(function(){
			if($.core.grids[0].checkSelect() == true){
				loadMain('baseRoleMenuPrivilege/detail.do?id=' + $.core.grids[0].curId);
			}
		})
		//删除角色菜单权限
		$('#delBtn').click(function(){
			if($.core.grids[0].checkSelect() == true){
				confirm("确认删除?",function(){
					ajaxGet("baseRoleMenuPrivilege/delete.do?id="+$.core.grids[0].curId,function(data){
						if(data.sign == true){
							alert("删除成功");
							refreshPage();
						}else{
