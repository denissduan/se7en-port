...
<div class="page-header">
	<form id="searchForm" action="btsdHourLine/query.do" method="post" class="form-inline" role="form">
...
<script type="text/javascript">
	(function(){
		...
		$('#newBtn').click(function(){
			loadMain('btsdHourLine/detail.do');
		})
		
		/*编辑格式化日期*/
		$('#editBtn').click(function(){
			if($.core.grids[0].checkSelect() == true){
				loadMain('btsdHourLine/detail.do?id=' + $.core.grids[0].curId);
			}
		})
		...
		$('#delBtn').click(function(){
			if($.core.grids[0].checkSelect() == true){
				confirm("确认删除?",function(){
					ajaxGet("btsdHourLine/delete.do?id="+$.core.grids[0].curId,function(data){
						if(data.sign == true){
							alert("删除成功");
							refreshPage();
						}else{
