...
<div class="page-header">
	<form id="searchForm" action="btsdHisTrade/query.do" method="post" class="form-inline" role="form">
...
<script type="text/javascript">
	(function(){
		...
		$('#newBtn').click(function(){
			loadMain('btsdHisTrade/detail.do');
		})
		
		/*编辑虚拟币名称*/
		$('#editBtn').click(function(){
			if($.core.grids[0].checkSelect() == true){
				loadMain('btsdHisTrade/detail.do?id=' + $.core.grids[0].curId);
			}
		})
		...
		$('#delBtn').click(function(){
			if($.core.grids[0].checkSelect() == true){
				confirm("确认删除?",function(){
					ajaxGet("btsdHisTrade/delete.do?id="+$.core.grids[0].curId,function(data){
						if(data.sign == true){
							alert("删除成功");
							refreshPage();
						}else{
