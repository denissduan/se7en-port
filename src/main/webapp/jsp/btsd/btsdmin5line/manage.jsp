...
<div class="page-header">
	<form id="searchForm" action="btsdMin5Line/query.do" method="post" class="form-inline" role="form">
...
<script type="text/javascript">
	(function(){
		...
		$('#newBtn').click(function(){
			loadMain('btsdMin5Line/detail.do');
		})
		
		/*编辑格式化日期*/
		$('#editBtn').click(function(){
			if($.core.grids[0].checkSelect() == true){
				loadMain('btsdMin5Line/detail.do?id=' + $.core.grids[0].curId);
			}
		})
		...
		$('#delBtn').click(function(){
			if($.core.grids[0].checkSelect() == true){
				confirm("确认删除?",function(){
					ajaxGet("btsdMin5Line/delete.do?id="+$.core.grids[0].curId,function(data){
						if(data.sign == true){
							alert("删除成功");
							refreshPage();
						}else{
