...
<script type="text/javascript">
	(function(){
		...
		$('#newBtn').click(function(){
			loadMain('hmmBtsdDetail/detail.do');
		})
		
		/*编辑$prop.OwnedComments.get(0).Body*/
		$('#editBtn').click(function(){
			if($.core.grids[0].checkSelect() == true){
				loadMain('hmmBtsdDetail/detail.do?id=' + $.core.grids[0].curId);
			}
		})
		...
		$('#delBtn').click(function(){
			if($.core.grids[0].checkSelect() == true){
				confirm("确认删除?",function(){
					ajaxGet("hmmBtsdDetail/delete.do?id="+$.core.grids[0].curId,function(data){
						if(data.sign == true){
							alert("删除成功");
							refreshPage();
						}else{
