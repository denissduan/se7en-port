...
%>
		...
		<script type="text/javascript">
			...
			window.jQuery || document.write("<script src='<%=basePath%>js/jquery-migrate-1.2.1.js'>"+"<"+"/script>");
		</script>
		...
		<script src="<%=basePath%>js/date-time/locales/bootstrap-datepicker.zh-CN.js"></script>
		...
		<!-- 百度地图 -->
		<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=B2bf4bf361be0b879d70ce60961e351d"></script>
		<!--加载鼠标绘制工具-->
