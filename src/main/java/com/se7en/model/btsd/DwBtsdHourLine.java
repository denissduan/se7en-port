...
/**
 * DwBtsdHourLine entity
 */
public class DwBtsdHourLine implements java.io.Serializable {

public final static DwBtsdHourLine EMPTY_DWBTSDHOURLINE = new DwBtsdHourLine();

	/** default constructor */
	public DwBtsdHourLine() {
	}
